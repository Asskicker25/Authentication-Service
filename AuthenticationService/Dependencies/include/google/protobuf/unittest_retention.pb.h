...
/* @@protoc_insertion_point(class_definition:protobuf_unittest.TopLevelMessage.NestedMessage) */ {
 public:
  ...
  TopLevelMessage_NestedMessage(TopLevelMessage_NestedMessage&& from) noexcept : TopLevelMessage_NestedMessage() {
    *this = ::std::move(from);
  }
...
/* @@protoc_insertion_point(class_definition:protobuf_unittest.TopLevelMessage) */ {
 public:
  ...
  TopLevelMessage(TopLevelMessage&& from) noexcept : TopLevelMessage() {
    *this = ::std::move(from);
  }
...
/* @@protoc_insertion_point(class_definition:protobuf_unittest.OptionsMessage) */ {
 public:
  ...
  OptionsMessage(OptionsMessage&& from) noexcept : OptionsMessage() {
    *this = ::std::move(from);
  }
...
/* @@protoc_insertion_point(class_definition:protobuf_unittest.Extendee) */ {
 public:
  ...
  Extendee(Extendee&& from) noexcept : Extendee() {
    *this = ::std::move(from);
  }
