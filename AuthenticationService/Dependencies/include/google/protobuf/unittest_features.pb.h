...
/* @@protoc_insertion_point(class_definition:pb.TestMessage.Nested) */ {
 public:
  ...
  TestMessage_Nested(TestMessage_Nested&& from) noexcept : TestMessage_Nested() {
    *this = ::std::move(from);
  }
...
class TestFeatures_MessageFeature final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:pb.TestFeatures.MessageFeature) */ {
 public:
  inline TestFeatures_MessageFeature() : TestFeatures_MessageFeature(nullptr) {}
  ~TestFeatures_MessageFeature() override;
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR TestFeatures_MessageFeature(
      ::google::protobuf::internal::ConstantInitialized);

  inline TestFeatures_MessageFeature(const TestFeatures_MessageFeature& from) : TestFeatures_MessageFeature(nullptr, from) {}
  TestFeatures_MessageFeature(TestFeatures_MessageFeature&& from) noexcept : TestFeatures_MessageFeature() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(TestFeatures_MessageFeature& a, TestFeatures_MessageFeature& b) { a.Swap(&b); }
  ...
  TestFeatures_MessageFeature* New(::google::protobuf::Arena* arena = nullptr) const final {
    return ::google::protobuf::Message::DefaultConstruct<TestFeatures_MessageFeature>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const TestFeatures_MessageFeature& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom(const TestFeatures_MessageFeature& from) { TestFeatures_MessageFeature::MergeImpl(*this, from); }
 ...
 private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() { return "pb.TestFeatures.MessageFeature"; }
...
/* @@protoc_insertion_point(class_definition:pb.TestFeatures) */ {
 public:
  ...
  TestFeatures(TestFeatures&& from) noexcept : TestFeatures() {
    *this = ::std::move(from);
  }
...
inline ::pb::TestFeatures_MessageFeature* TestFeatures::_internal_mutable_message_field_feature() {
  ...
  if (_impl_.message_field_feature_ == nullptr) {
    auto* p = ::google::protobuf::Message::DefaultConstruct<::pb::TestFeatures_MessageFeature>(GetArena());
