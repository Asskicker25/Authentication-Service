...
/* @@protoc_insertion_point(class_definition:protobuf_unittest.TestMessageSetLite) */ {
 public:
  ...
  TestMessageSetLite(TestMessageSetLite&& from) noexcept : TestMessageSetLite() {
    *this = ::std::move(from);
  }
...
/* @@protoc_insertion_point(class_definition:protobuf_unittest.TestMergeExceptionLite) */ {
 public:
  ...
  TestMergeExceptionLite(TestMergeExceptionLite&& from) noexcept : TestMergeExceptionLite() {
    *this = ::std::move(from);
  }
