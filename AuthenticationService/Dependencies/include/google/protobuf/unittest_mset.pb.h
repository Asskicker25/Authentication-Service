...
/* @@protoc_insertion_point(class_definition:protobuf_unittest.NestedTestInt) */ {
 public:
  ...
  NestedTestInt(NestedTestInt&& from) noexcept : NestedTestInt() {
    *this = ::std::move(from);
  }
...
/* @@protoc_insertion_point(class_definition:protobuf_unittest.TestMessageSetExtension3) */ {
 public:
  ...
  TestMessageSetExtension3(TestMessageSetExtension3&& from) noexcept : TestMessageSetExtension3() {
    *this = ::std::move(from);
  }
...
/* @@protoc_insertion_point(class_definition:protobuf_unittest.NestedTestMessageSetContainer) */ {
 public:
  ...
  NestedTestMessageSetContainer(NestedTestMessageSetContainer&& from) noexcept : NestedTestMessageSetContainer() {
    *this = ::std::move(from);
  }
