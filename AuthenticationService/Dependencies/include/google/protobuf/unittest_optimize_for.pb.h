...
/* @@protoc_insertion_point(class_definition:protobuf_unittest.TestRequiredOptimizedForSize) */ {
 public:
  ...
  TestRequiredOptimizedForSize(TestRequiredOptimizedForSize&& from) noexcept : TestRequiredOptimizedForSize() {
    *this = ::std::move(from);
  }
...
/* @@protoc_insertion_point(class_definition:protobuf_unittest.TestOptionalOptimizedForSize) */ {
 public:
  ...
  TestOptionalOptimizedForSize(TestOptionalOptimizedForSize&& from) noexcept : TestOptionalOptimizedForSize() {
    *this = ::std::move(from);
  }
...
/* @@protoc_insertion_point(class_definition:protobuf_unittest.TestOptimizedForSize) */ {
 public:
  ...
  TestOptimizedForSize(TestOptimizedForSize&& from) noexcept : TestOptimizedForSize() {
    *this = ::std::move(from);
  }
