...
enum CreateAccountWebFailure_Reason : int {
  CreateAccountWebFailure_Reason_ACCOUNT_ALREADY_EXISTS = 1,
  CreateAccountWebFailure_Reason_INVALID_PASSWORD = 2,
  CreateAccountWebFailure_Reason_INTERNAL_SERVER_ERROR = 3,
};

bool CreateAccountWebFailure_Reason_IsValid(int value);
extern const uint32_t CreateAccountWebFailure_Reason_internal_data_[];
constexpr CreateAccountWebFailure_Reason CreateAccountWebFailure_Reason_Reason_MIN = static_cast<CreateAccountWebFailure_Reason>(1);
constexpr CreateAccountWebFailure_Reason CreateAccountWebFailure_Reason_Reason_MAX = static_cast<CreateAccountWebFailure_Reason>(3);
constexpr int CreateAccountWebFailure_Reason_Reason_ARRAYSIZE = 3 + 1;
...
constexpr AuthenticateWebFailure_Reason AuthenticateWebFailure_Reason_Reason_MIN = static_cast<AuthenticateWebFailure_Reason>(1);
constexpr AuthenticateWebFailure_Reason AuthenticateWebFailure_Reason_Reason_MAX = static_cast<AuthenticateWebFailure_Reason>(2);
constexpr int AuthenticateWebFailure_Reason_Reason_ARRAYSIZE = 2 + 1;
const ::google::protobuf::EnumDescriptor*
...
/* @@protoc_insertion_point(class_definition:Authentication.CreateAccountWebSuccess) */ {
 public:
  ...
  CreateAccountWebSuccess(CreateAccountWebSuccess&& from) noexcept : CreateAccountWebSuccess() {
    *this = ::std::move(from);
  }
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "Authentication.CreateAccountWebSuccess"; }
...
/* @@protoc_insertion_point(class_definition:Authentication.CreateAccountWebFailure) */ {
 public:
  ...
  CreateAccountWebFailure(CreateAccountWebFailure&& from) noexcept : CreateAccountWebFailure() {
    *this = ::std::move(from);
  }
 ...
 private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() { return "Authentication.CreateAccountWebFailure"; }
...
/* @@protoc_insertion_point(class_definition:Authentication.CreateAccountWeb) */ {
 public:
  ...
  CreateAccountWeb(CreateAccountWeb&& from) noexcept : CreateAccountWeb() {
    *this = ::std::move(from);
  }
 ...
 private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() { return "Authentication.CreateAccountWeb"; }
...
/* @@protoc_insertion_point(class_definition:Authentication.AuthenticateWebSuccess) */ {
 public:
  ...
  AuthenticateWebSuccess(AuthenticateWebSuccess&& from) noexcept : AuthenticateWebSuccess() {
    *this = ::std::move(from);
  }
 ...
 private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() { return "Authentication.AuthenticateWebSuccess"; }
...
/* @@protoc_insertion_point(class_definition:Authentication.AuthenticateWebFailure) */ {
 public:
  ...
  AuthenticateWebFailure(AuthenticateWebFailure&& from) noexcept : AuthenticateWebFailure() {
    *this = ::std::move(from);
  }
 ...
 private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() { return "Authentication.AuthenticateWebFailure"; }
...
/* @@protoc_insertion_point(class_definition:Authentication.AuthenticateWeb) */ {
 public:
  ...
  AuthenticateWeb(AuthenticateWeb&& from) noexcept : AuthenticateWeb() {
    *this = ::std::move(from);
  }
 ...
 private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() { return "Authentication.AuthenticateWeb"; }
...
inline ::Authentication::CreateAccountWebFailure_Reason CreateAccountWebFailure::_internal_reason() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return static_cast<::Authentication::CreateAccountWebFailure_Reason>(_impl_.reason_);
}
...
inline ::Authentication::AuthenticateWebFailure_Reason AuthenticateWebFailure::_internal_reason() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return static_cast<::Authentication::AuthenticateWebFailure_Reason>(_impl_.reason_);
}
...
template <>
struct is_proto_enum<::Authentication::CreateAccountWebFailure_Reason> : std::true_type {};
template <>
...
template <>
struct is_proto_enum<::Authentication::AuthenticateWebFailure_Reason> : std::true_type {};
template <>
